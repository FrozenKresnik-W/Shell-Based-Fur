Shader "Aperture/ProceduralShellBasedFur"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Includes/Procedural.hlsl"
            ...
            Varyings LitPassVertex(Attributes input)
            {
                ...
                float3 positionOS = GetVertexData_Position(input.vertexID);
                half3 normalOS = GetVertexData_Normal(input.vertexID);
                real2 uv = GetVertexData_TexCoord0(input.vertexID);
                half4 color = GetVertexData_Color(input.vertexID);
